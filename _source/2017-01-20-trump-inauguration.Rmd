...
```{r, fig.cap="Total number of words for each inaugural address"}
library(ggplot2)
...
```{r, fig.cap="Number of unique words per 1000 words for each inaugural address"}
...
```{r, fig.cap="Number of times the word 'America' appeared in each inaugural address"}
address_tokenized %>% 
  group_by(Year) %>%
...
```{r, fig.cap="Number of times the word 'Great' appeared in each inaugural address"}
address_tokenized %>% 
  group_by(Year) %>%
...
```{r, fig.cap="Number of times per 1000 words the word 'Great' appeared in each inaugural address"}
